...
PROJECTS_TO_PUBLISH="alfresco-content-services alfresco-content-services/charts/alfresco-common"

for PROJECT_NAME in $PROJECTS_TO_PUBLISH; do echo "Attempting to publish $PROJECT_NAME"
