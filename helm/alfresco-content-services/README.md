...
| alfresco-ai-transformer.image.tag | string | `"3.1.0-A1"` |  |
...
| alfresco-control-center.image.tag | string | `"8.4.0-7989911312"` |  |
...
| alfresco-digital-workspace.image.tag | string | `"4.4.0-7989911312"` |  |
...
| alfresco-repository.image.tag | string | `"23.2.0-A21"` |  |
...
| alfresco-search.insightEngineImage.tag | string | `"2.0.9.1"` |  |
...
| alfresco-search.searchServicesImage.tag | string | `"2.0.9.1"` |  |
...
| alfresco-sync-service.image.tag | string | `"5.0.0-A14"` |  |
...
| alfresco-transform-service.filestore.image.tag | string | `"4.1.0-A1"` |  |
...
| alfresco-transform-service.imagemagick.image.tag | string | `"5.1.0"` |  |
...
| alfresco-transform-service.libreoffice.image.tag | string | `"5.1.0"` |  |
...
| alfresco-transform-service.pdfrenderer.image.tag | string | `"5.1.0"` |  |
...
| alfresco-transform-service.tika.image.tag | string | `"5.1.0-A1"` |  |
...
| alfresco-transform-service.transformmisc.image.tag | string | `"5.1.0"` |  |
...
| alfresco-transform-service.transformrouter.image.tag | string | `"4.1.0-A1"` |  |
...
| share.image.tag | string | `"23.2.0-A21"` |  |
