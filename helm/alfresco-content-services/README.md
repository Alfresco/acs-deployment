...
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-connector-ms365 | 0.1.0-alpha.0 |
...
| aiTransformer.image.tag | string | `"1.6.0-A1"` |  |
...
| alfresco-connector-ms365 | object | `{"enabled":false,"environment":null,"image":{"internalPort":9095,"pullPolicy":"IfNotPresent","repository":"quay.io/alfresco/alfresco-ooi-service","tag":"2.0.0"},"ingress":{"path":"/ooi-service","tls":[]},"livenessProbe":{"initialDelaySeconds":10,"periodSeconds":20,"timeoutSeconds":10},"nodeSelector":{},"podSecurityContext":{"runAsNonRoot":true,"runAsUser":33006},"readinessProbe":{"initialDelaySeconds":20,"periodSeconds":60,"timeoutSeconds":10},"replicaCount":2,"repository":{"host":"acs-alfresco-cs-repository","port":80},"resources":{"limits":{"cpu":"2","memory":"1000Mi"},"requests":{"cpu":"0.25","memory":"1000Mi"}},"service":{"externalPort":80,"name":"ms365-service","type":"ClusterIP"}}` | Enable/Disable Alfresco Collaboration Connector for Microsoft 365 |
...
| alfresco-control-center.image.tag | string | `"8.1.0-5090171880"` |  |
...
| alfresco-digital-workspace.image.tag | string | `"4.1.0-5090171880"` |  |
...
| alfresco-sync-service.image.tag | string | `"3.9.0"` |  |
...
| repository.image.tag | string | `"23.1.0-A12"` |  |
...
| transformrouter.image.tag | string | `"2.2.0-A1"` |  |
