...
![Version: 10.2.0](https://img.shields.io/badge/Version-10.2.0-informational?style=flat-square) ![AppVersion: 26.1.0-A.17](https://img.shields.io/badge/AppVersion-26.1.0--A.17-informational?style=flat-square)
...
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-audit-storage | 0.7.3 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-common | 5.0.0-alpha.0 |
...
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-repository | 1.0.0-alpha.0 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-search-enterprise | 4.9.0 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-search(alfresco-search-service) | 6.0.0-alpha.0 |
| https://alfresco.github.io/alfresco-helm-charts/ | share(alfresco-share) | 2.0.0-alpha.0 |
...
| activemq.image.tag | string | `"6.2.1-jre17-rockylinux8"` |  |
...
| alfresco-ai-transformer.image.tag | string | `"3.3.2-A.2"` |  |
...
| alfresco-audit-storage.image.tag | string | `"1.3.0-A.3"` |  |
...
| alfresco-connector-ms365.image.tag | string | `"2.1.0-A.2"` |  |
...
| alfresco-connector-msteams.image.tag | string | `"2.1.0-A.4"` |  |
...
| alfresco-control-center.image.tag | string | `"10.3.0-22434626274"` |  |
...
| alfresco-digital-workspace.image.tag | string | `"7.3.0-22434626274"` |  |
...
| alfresco-repository.image.tag | string | `"26.1.0-A.17"` |  |
...
| alfresco-search-enterprise.liveIndexing.content.image.tag | string | `"5.4.0-A.2"` |  |
| alfresco-search-enterprise.liveIndexing.mediation.image.tag | string | `"5.4.0-A.2"` |  |
| alfresco-search-enterprise.liveIndexing.metadata.image.tag | string | `"5.4.0-A.2"` |  |
| alfresco-search-enterprise.liveIndexing.path.image.tag | string | `"5.4.0-A.2"` |  |
...
| alfresco-search-enterprise.reindexing.image.tag | string | `"5.4.0-A.2"` |  |
...
| alfresco-transform-service.filestore.image.tag | string | `"4.3.2-A.2"` |  |
...
| alfresco-transform-service.imagemagick.image.tag | string | `"5.3.2-A.2"` |  |
...
| alfresco-transform-service.libreoffice.image.tag | string | `"5.3.2-A.2"` |  |
...
| alfresco-transform-service.pdfrenderer.image.tag | string | `"5.3.2-A.2"` |  |
...
| alfresco-transform-service.tika.image.tag | string | `"5.3.2-A.2"` |  |
...
| alfresco-transform-service.transformmisc.image.tag | string | `"5.3.2-A.2"` |  |
...
| alfresco-transform-service.transformrouter.image.tag | string | `"4.3.2-A.2"` |  |
...
| dtas.config.assertions.acs.modules[0].version | string | `"5.3.0"` |  |
...
| dtas.config.assertions.acs.modules[2].version | string | `"3.4.0"` |  |
| dtas.config.assertions.acs.version | string | `"25.3.0"` |  |
...
| share.image.tag | string | `"26.1.0-A.17"` |  |
