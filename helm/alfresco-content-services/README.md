...
![Version: 10.2.0](https://img.shields.io/badge/Version-10.2.0-informational?style=flat-square) ![AppVersion: 26.1.0](https://img.shields.io/badge/AppVersion-26.1.0-informational?style=flat-square)
...
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-search-enterprise | 4.10.0-alpha.0 |
...
| alfresco-ai-transformer.image.tag | string | `"3.4.0"` |  |
...
| alfresco-audit-storage.image.tag | string | `"1.3.0"` |  |
...
| alfresco-connector-ms365.image.tag | string | `"2.1.0"` |  |
...
| alfresco-connector-msteams.image.tag | string | `"2.1.0"` |  |
...
| alfresco-search-enterprise.liveIndexing.content.image.tag | string | `"5.4.0"` |  |
| alfresco-search-enterprise.liveIndexing.mediation.image.tag | string | `"5.4.0"` |  |
| alfresco-search-enterprise.liveIndexing.metadata.image.tag | string | `"5.4.0"` |  |
| alfresco-search-enterprise.liveIndexing.path.image.tag | string | `"5.4.0"` |  |
...
| alfresco-search-enterprise.reindexing.image.tag | string | `"5.4.0"` |  |
...
| alfresco-sync-service.image.tag | string | `"5.3.1"` |  |
...
| alfresco-transform-service.filestore.image.tag | string | `"4.4.0"` |  |
...
| alfresco-transform-service.imagemagick.image.tag | string | `"5.4.0"` |  |
...
| alfresco-transform-service.libreoffice.image.tag | string | `"5.4.0"` |  |
...
| alfresco-transform-service.pdfrenderer.image.tag | string | `"5.4.0"` |  |
...
| alfresco-transform-service.tika.image.tag | string | `"5.4.0"` |  |
...
| alfresco-transform-service.transformmisc.image.tag | string | `"5.4.0"` |  |
...
| alfresco-transform-service.transformrouter.image.tag | string | `"4.4.0"` |  |
