...
| filestore.persistence.storageClass | object | `{"accessModes":["ReadWriteMany"],"enabled":true,"name":null}` | Specify a storageClass for dynamic provisioning |
