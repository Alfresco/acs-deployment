...
| ai | object | `{"enabled":false}` | Choose if you want AI capabilities |
...
| alfresco-digital-workspace.extraEnv | string | `"- name: APP_CONFIG_PLUGIN_AI_SERVICE\n  value: 'false'"` |  |
