...
| ooiService | object | `{"enabled":false,"image":{"tag":"2.0.0"},"repository":{"nameOverride":"acs-alfresco-cs-repository","port":80}}` | Enable/Disable Alfresco Collaboration Connector for Microsoft 365 |
