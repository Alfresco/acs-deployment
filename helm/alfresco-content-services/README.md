...
| aiTransformer.resources.limits.cpu | string | `"1"` |  |
| aiTransformer.resources.limits.memory | string | `"1000Mi"` |  |
| aiTransformer.resources.requests.cpu | string | `"1"` |  |
...
| msTeamsService.resources.requests.cpu | string | `"1"` |  |
...
| ooiService.resources.requests.cpu | string | `"1"` |  |
...
| repository.initContainers.db.resources.limits.cpu | string | `"0.5"` |  |
...
| repository.resources.requests.cpu | string | `"2"` |  |
...
| transformrouter.resources.requests.cpu | string | `"0.5"` |  |
