...
![Version: 5.0.0-M1](https://img.shields.io/badge/Version-5.0.0--M1-informational?style=flat-square)
...
| https://charts.bitnami.com/bitnami | postgresql | 8.9.6 |
| https://kubernetes-charts.alfresco.com/stable | alfresco-adf-app | 7.1.0-M10 |
...
| aiTransformer.environment.JAVA_OPTS | string | `" -Xms256M -Xmx512M"` |  |
...
| aiTransformer.image.tag | string | `"1.2.1"` |  |
...
| alfresco-search.searchServicesImage.tag | string | `"2.0.0"` |  |
...
| filestore.environment.JAVA_OPTS | string | `" -Xms256M -Xmx512M"` |  |
| filestore.image.internalPort | int | `8099` |  |
| filestore.image.pullPolicy | string | `"Always"` |  |
| filestore.image.repository | string | `"alfresco/alfresco-shared-file-store"` |  |
| filestore.image.tag | string | `"0.10.0"` |  |
| filestore.initContainer.image.repository | string | `"busybox"` |  |
| filestore.initContainer.image.tag | string | `"latest"` |  |
...
| imagemagick.environment.JAVA_OPTS | string | `" -Xms256M -Xmx512M"` |  |
...
| imagemagick.image.tag | string | `"2.3.5"` |  |
...
| libreoffice.environment.JAVA_OPTS | string | `" -Xms256M -Xmx512M"` |  |
...
| libreoffice.image.tag | string | `"2.3.5"` |  |
...
| pdfrenderer.environment.JAVA_OPTS | string | `" -Xms256M -Xmx512M"` |  |
...
| pdfrenderer.image.tag | string | `"2.3.5"` |  |
...
| postgresql.postgresConfig.log_min_messages | string | `"LOG"` |  |
| postgresql.postgresConfig.max_connections | int | `300` |  |
...
| repository.environment.JAVA_OPTS | string | `" -Dsolr.base.url=/solr -Dsolr.secureComms=none -Dindex.subsystem.name=solr6 -Dalfresco.cluster.enabled=true -Ddeployment.method=HELM_CHART -Dtransform.service.enabled=true -Xms2000M -Xmx2000M"` |  |
...
| repository.image.repository | string | `"alfresco/alfresco-content-repository"` |  |
| repository.image.tag | string | `"7.0.0-M2"` |  |
| repository.ingress.annotations | object | `{}` |  |
| repository.ingress.maxUploadSize | string | `"5g"` |  |
| repository.ingress.path | string | `"/"` |  |
| repository.initContainer.image.repository | string | `"busybox"` |  |
| repository.initContainer.image.tag | string | `"latest"` |  |
...
| share.environment.CATALINA_OPTS | string | `" -Xms1000M -Xmx1000M"` |  |
| share.image.internalPort | int | `8080` |  |
| share.image.pullPolicy | string | `"Always"` |  |
| share.image.repository | string | `"alfresco/alfresco-share"` |  |
| share.image.tag | string | `"7.0.0-M2"` |  |
...
| transformmisc.environment.JAVA_OPTS | string | `" -Xms256M -Xmx512M"` |  |
...
| transformmisc.image.tag | string | `"2.3.5"` |  |
...
| transformrouter.environment.JAVA_OPTS | string | `" -Xms256M -Xmx512M"` |  |
...
| transformrouter.image.tag | string | `"1.3.1"` |  |
