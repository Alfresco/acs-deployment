...
![Version: 10.8.0](https://img.shields.io/badge/Version-10.8.0-informational?style=flat-square) ![AppVersion: 26.2.2](https://img.shields.io/badge/AppVersion-26.2.2-informational?style=flat-square)
...
|------------|------|---------|
| https://alfresco.github.io/alfresco-helm-charts/ | activemq | 4.2.1 |
...
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-ai-transformer | 3.8.2 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-audit-storage | 0.11.2 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-common | 5.1.0 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-connector-cic | 0.1.0 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-connector-ms365 | 3.8.2 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-connector-msteams | 2.8.2 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-repository | 1.10.0 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-search-community | 0.3.0 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-search-enterprise | 5.3.0 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-search(alfresco-search-service) | 6.3.2 |
| https://alfresco.github.io/alfresco-helm-charts/ | share(alfresco-share) | 2.5.1 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-sync-service | 7.12.2 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-transform-service | 2.9.2 |
...
| activemq.image.tag | string | `"6.2.9-jre17-rockylinux8"` |  |
...
| alfresco-ai-transformer.image.tag | string | `"3.4.5"` |  |
...
| alfresco-audit-storage.image.tag | string | `"1.3.4"` |  |
...
| alfresco-connector-ms365.image.tag | string | `"2.1.4"` |  |
...
| alfresco-connector-msteams.image.tag | string | `"2.1.4"` |  |
...
| alfresco-control-center.image.tag | string | `"11.0.0"` |  |
...
| alfresco-digital-workspace.image.tag | string | `"8.0.0"` |  |
...
| alfresco-repository.configuration.search.existingSecret.keys.solr-secret | string | `nil` | Only needed when authenticating against Solr's legacy tracking webscripts API: set to SOLR_SECRET for the Community profile (see community_values.yaml) or when switching to legacy Search Services (Solr) |
...
| alfresco-repository.image.tag | string | `"26.2.2"` |  |
...
| alfresco-search-enterprise.liveIndexing.content.image.tag | string | `"5.8.0"` |  |
| alfresco-search-enterprise.liveIndexing.mediation.image.tag | string | `"5.8.0"` |  |
| alfresco-search-enterprise.liveIndexing.metadata.image.tag | string | `"5.8.0"` |  |
| alfresco-search-enterprise.liveIndexing.path.image.tag | string | `"5.8.0"` |  |
...
| alfresco-search-enterprise.reindexing.image.tag | string | `"5.8.0"` |  |
...
| alfresco-search.enabled | bool | `false` | Search Services (`alfresco-search`) is no longer supported for Enterprise edition starting with ACS v26 |
...
| alfresco-search.insightEngineImage.tag | string | `nil` |  |
...
| alfresco-search.searchServicesImage.tag | string | `nil` |  |
...
| alfresco-sync-service.image.tag | string | `"5.3.6"` |  |
...
| alfresco-transform-service.filestore.image.tag | string | `"4.4.4"` |  |
...
| alfresco-transform-service.imagemagick.image.tag | string | `"5.4.4"` |  |
...
| alfresco-transform-service.libreoffice.image.tag | string | `"5.4.4"` |  |
...
| alfresco-transform-service.pdfrenderer.image.tag | string | `"5.4.4"` |  |
...
| alfresco-transform-service.tika.image.tag | string | `"5.4.4"` |  |
...
| alfresco-transform-service.transformmisc.image.tag | string | `"5.4.4"` |  |
...
| alfresco-transform-service.transformrouter.image.tag | string | `"4.4.4"` |  |
...
| dtas.config.assertions.acs.modules[2].version | string | `"3.4.1"` |  |
| dtas.config.assertions.acs.version | string | `"26.2.0"` |  |
