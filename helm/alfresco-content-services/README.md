...
![Version: 10.0.0](https://img.shields.io/badge/Version-10.0.0-informational?style=flat-square) ![AppVersion: 25.2.0](https://img.shields.io/badge/AppVersion-25.2.0-informational?style=flat-square)
...
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-ai-transformer | 3.1.2 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-audit-storage | 0.3.3 |
...
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-connector-ms365 | 3.2.1 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-connector-msteams | 2.2.1 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-repository | 0.10.1 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-search-enterprise | 4.6.0 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-search(alfresco-search-service) | 5.1.1 |
| https://alfresco.github.io/alfresco-helm-charts/ | share(alfresco-share) | 1.4.0 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-sync-service | 7.3.0 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-transform-service | 2.2.2 |
| https://alfresco.github.io/alfresco-helm-charts/ | elasticsearch(elastic) | 0.1.2 |
| https://alfresco.github.io/alfresco-helm-charts/ | postgresql(postgres) | 0.1.2 |
| https://alfresco.github.io/alfresco-helm-charts/ | postgresql-sync(postgres) | 0.1.2 |
...
| alfresco-ai-transformer.image.tag | string | `"3.2.2"` |  |
...
| alfresco-connector-ms365.image.tag | string | `"2.0.8"` |  |
...
| alfresco-connector-msteams.image.tag | string | `"2.0.8"` |  |
...
| alfresco-control-center.image.tag | string | `"10.1.0"` |  |
...
| alfresco-digital-workspace.image.tag | string | `"7.1.1"` |  |
...
| alfresco-search-enterprise.liveIndexing.content.image.tag | string | `"5.2.0"` |  |
| alfresco-search-enterprise.liveIndexing.mediation.image.tag | string | `"5.2.0"` |  |
| alfresco-search-enterprise.liveIndexing.metadata.image.tag | string | `"5.2.0"` |  |
| alfresco-search-enterprise.liveIndexing.path.image.tag | string | `"5.2.0"` |  |
...
| alfresco-search-enterprise.reindexing.image.tag | string | `"5.2.0"` |  |
...
| alfresco-search.insightEngineImage.tag | string | `"2.0.17"` |  |
...
| alfresco-search.searchServicesImage.tag | string | `"2.0.17"` |  |
...
| alfresco-sync-service.image.tag | string | `"5.3.0"` |  |
...
| alfresco-transform-service.filestore.image.tag | string | `"4.2.2"` |  |
...
| alfresco-transform-service.imagemagick.image.tag | string | `"5.2.2"` |  |
...
| alfresco-transform-service.libreoffice.image.tag | string | `"5.2.2"` |  |
...
| alfresco-transform-service.pdfrenderer.image.tag | string | `"5.2.2"` |  |
...
| alfresco-transform-service.tika.image.tag | string | `"5.2.2"` |  |
...
| alfresco-transform-service.transformmisc.image.tag | string | `"5.2.2"` |  |
...
| alfresco-transform-service.transformrouter.image.tag | string | `"4.2.2"` |  |
...
| dtas.config.assertions.acs.modules[2].version | string | `"3.3.0"` |  |
| dtas.config.assertions.acs.version | string | `"25.2.0"` |  |
