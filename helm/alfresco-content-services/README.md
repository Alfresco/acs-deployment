...
| alfresco-ai-transformer.image.tag | string | `"3.4.3"` |  |
...
| alfresco-audit-storage.image.tag | string | `"1.3.2"` |  |
...
| alfresco-connector-ms365.image.tag | string | `"2.1.2"` |  |
...
| alfresco-connector-msteams.image.tag | string | `"2.1.2"` |  |
...
| alfresco-control-center.image.tag | string | `"10.5.0"` |  |
...
| alfresco-digital-workspace.image.tag | string | `"7.5.0"` |  |
...
| alfresco-search-enterprise.liveIndexing.mediation.image.tag | string | `"5.6.0"` |  |
| alfresco-search-enterprise.liveIndexing.metadata.image.tag | string | `"5.6.0"` |  |
| alfresco-search-enterprise.liveIndexing.path.image.tag | string | `"5.6.0"` |  |
...
| alfresco-search-enterprise.reindexing.image.tag | string | `"5.6.0"` |  |
...
| alfresco-sync-service.image.tag | string | `"5.3.4"` |  |
...
| alfresco-transform-service.filestore.image.tag | string | `"4.4.2"` |  |
...
| alfresco-transform-service.imagemagick.image.tag | string | `"5.4.2"` |  |
...
| alfresco-transform-service.libreoffice.image.tag | string | `"5.4.2"` |  |
...
| alfresco-transform-service.pdfrenderer.image.tag | string | `"5.4.2"` |  |
...
| alfresco-transform-service.tika.image.tag | string | `"5.4.2"` |  |
...
| alfresco-transform-service.transformmisc.image.tag | string | `"5.4.2"` |  |
...
| alfresco-transform-service.transformrouter.image.tag | string | `"4.4.2"` |  |
