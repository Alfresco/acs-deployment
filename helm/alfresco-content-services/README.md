...
| alfresco-digital-workspace.image.tag | string | `"2.7.0"` |  |
...
| repository.image.tag | string | `"7.2.0"` |  |
...
| transformrouter.image.tag | string | `"1.5.2"` |  |
