...
![Version: 10.7.0](https://img.shields.io/badge/Version-10.7.0-informational?style=flat-square) ![AppVersion: 26.2.0](https://img.shields.io/badge/AppVersion-26.2.0-informational?style=flat-square)
...
| alfresco-ai-transformer.image.tag | string | `"3.4.4"` |  |
...
| alfresco-audit-storage.image.tag | string | `"1.3.3"` |  |
...
| alfresco-connector-msteams.image.tag | string | `"2.1.3"` |  |
...
| alfresco-sync-service.image.tag | string | `"5.3.5"` |  |
...
| alfresco-transform-service.filestore.image.tag | string | `"4.4.3"` |  |
...
| alfresco-transform-service.imagemagick.image.tag | string | `"5.4.3"` |  |
...
| alfresco-transform-service.libreoffice.image.tag | string | `"5.4.3"` |  |
...
| alfresco-transform-service.pdfrenderer.image.tag | string | `"5.4.3"` |  |
...
| alfresco-transform-service.tika.image.tag | string | `"5.4.3"` |  |
...
| alfresco-transform-service.transformmisc.image.tag | string | `"5.4.3"` |  |
...
| alfresco-transform-service.transformrouter.image.tag | string | `"4.4.3"` |  |
