...
![Version: 10.6.0](https://img.shields.io/badge/Version-10.6.0-informational?style=flat-square) ![AppVersion: 26.1.0](https://img.shields.io/badge/AppVersion-26.1.0-informational?style=flat-square)
...
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-control-center(alfresco-adf-app) | 0.7.0 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-digital-workspace(alfresco-adf-app) | 0.7.0 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-ai-transformer | 3.7.0 |
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-audit-storage | 0.10.0 |
...
| https://alfresco.github.io/alfresco-helm-charts/ | alfresco-transform-service | 2.8.0 |
| https://alfresco.github.io/alfresco-helm-charts/ | elasticsearch(elastic) | 0.6.0 |
| https://alfresco.github.io/alfresco-helm-charts/ | postgresql(postgres) | 0.5.0 |
| https://alfresco.github.io/alfresco-helm-charts/ | postgresql-sync(postgres) | 0.5.0 |
...
| activemq.image.tag | string | `"6.2.4-jre17-rockylinux8"` |  |
...
| alfresco-ai-transformer.image.tag | string | `"3.4.1"` |  |
...
| alfresco-audit-storage.image.tag | string | `"1.3.1"` |  |
...
| alfresco-connector-ms365.image.tag | string | `"2.1.1"` |  |
...
| alfresco-connector-msteams.image.tag | string | `"2.1.1"` |  |
...
| alfresco-repository.image.tag | string | `"26.1.0"` |  |
...
| alfresco-search-enterprise.liveIndexing.content.image.tag | string | `"5.5.0"` |  |
| alfresco-search-enterprise.liveIndexing.mediation.image.tag | string | `"5.5.0"` |  |
| alfresco-search-enterprise.liveIndexing.metadata.image.tag | string | `"5.5.0"` |  |
| alfresco-search-enterprise.liveIndexing.path.image.tag | string | `"5.5.0"` |  |
...
| alfresco-search-enterprise.reindexing.image.tag | string | `"5.5.0"` |  |
...
| alfresco-transform-service.filestore.image.tag | string | `"4.4.1"` |  |
...
| alfresco-transform-service.imagemagick.image.tag | string | `"5.4.1"` |  |
...
| alfresco-transform-service.libreoffice.image.tag | string | `"5.4.1"` |  |
...
| alfresco-transform-service.pdfrenderer.image.tag | string | `"5.4.1"` |  |
...
| alfresco-transform-service.tika.image.tag | string | `"5.4.1"` |  |
...
| alfresco-transform-service.transformmisc.image.tag | string | `"5.4.1"` |  |
...
| alfresco-transform-service.transformrouter.image.tag | string | `"4.4.1"` |  |
...
| dtas.config.assertions.acs.version | string | `"26.1.0"` |  |
