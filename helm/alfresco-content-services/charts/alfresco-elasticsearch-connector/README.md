...
| reindexing.initcontainers.waitForRepository.resources.limits.cpu | float | `0.5` |  |
...
| reindexing.resources.limits.cpu | int | `2` |  |
| reindexing.resources.limits.memory | string | `"512Mi"` |  |
| reindexing.resources.requests.cpu | float | `0.5` |  |
