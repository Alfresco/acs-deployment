...
**Please Note:** By default the Alfresco Search services `/solr` endpoint is disabled for external access.  To enable it, please see example [search-external-access](examples/search-external-access.md).
